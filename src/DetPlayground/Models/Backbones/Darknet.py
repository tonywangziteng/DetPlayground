...
class CSPDarknet(nn.Module):
    def __init__(
        self,
        dep_mul: float, # nano:0.33, s: 0.33, tiny: 0.33 m: 0.67, l: 1.0, x: 1.33
        wid_mul: float, # nano:0.25, s: 0.50, tiny: 0.375, m: 0.75, l: 1.0, x: 1.25
